...
<xsl:stylesheet version="1.0"
  ...
  exclude-result-prefixes="marc items">
    <xsl:import href="neklsopacMARC21slimUtils.xsl"/>
   ...
   <xsl:if test="$DisplayOPACiconsXSLT!='0'">
        ...
        <span class="results_summary description"><span class="label"><b>Material type: </b></span>
        ...
        <span class="results_summary series"><span class="label"><b>Series: </b></span>
        <!-- 440 -->
        ...
        <span class="results_summary description"><span class="label"><b>Publisher: </b></span>
        ...
        <xsl:if test="$display880">
            <xsl:call-template name="m880Select">
                ...
                <xsl:with-param name="label"><b>Description: </b></xsl:with-param>
            </xsl:call-template>
        </xsl:if>

        <xsl:if test="marc:datafield[@tag=300]">
        <span class="results_summary description"><span class="label"><b>Description: </b></span>
        ...
        <xsl:if test="marc:datafield[@tag=020]/marc:subfield[@code='a']">
          <span class="results_summary description"><span class="label"><b>ISBN: </b></span>
        ...
        <xsl:if test="$display880">
            <xsl:call-template name="m880Select">
                ...
                <xsl:with-param name="label"><b>Other title: </b></xsl:with-param>
            </xsl:call-template>
        </xsl:if>

        <xsl:if test="marc:datafield[@tag=246]">
        <span class="results_summary description"><span class="label"><b>Other title: </b></span>
...
<!-- Audience info -->
      <xsl:if test="marc:datafield[@tag=521]">
         <span class="results_summary description"><span class="label"><b>Audience: </b></span>
...
<!-- Reading Level 526 -->
      <xsl:if test="marc:datafield[@tag=526]">
        <span class="results_summary description"><span class="label"><b>AR/Lexile score: </b></span>
...
<!-- System Requirements -->
      <xsl:if test="marc:datafield[@tag=538]">
        <span class="results_summary description"><span class="label"><b>System Requirements: </b></span>
...
<!-- Subjects --> 
        <xsl:if test="marc:datafield[substring(@tag, 1, 1) = '6']">
            <span class="results_summary subjects"><span class="label"><b>Subject(s): </b></span>
